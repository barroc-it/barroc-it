	...
	<div class="addCustumer">
		<form method="post" action="../controllers/usersController.php" role="form" class="col-md-6">
		    <div class="form-group">
		        ...
		        <input class="col-md-6" type="text" id="companyName" name="companyName">
		    </div>
<br>
		    <div class="form-group">
		        <label class="col-md-4"for="address">address</label>
		        <input class="col-md-6" type="text" id="address" name="address">
		    </div>
<br>
		    <div class="form-group">
		        <label class="col-md-4" for="postcode">postcode</label>
		        <input class="col-md-6" type="text" id="postcode" name="postcode">
		    </div>
<br>
		    <div class="form-group">
		        <label class="col-md-4" for="residence">residence</label>
		        <input class="col-md-6" type="text" id="residence" name="residence">
		    </div>
<br>
		    <div class="form-group">
		        <label class="col-md-4" for="telephoneNumber">telephoneNumber</label>
		        <input class="col-md-6" type="text" id="telephoneNumber" name="telephoneNumber">
		    </div>
<br>	
		    <div class="form-group">
