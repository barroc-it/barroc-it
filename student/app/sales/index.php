...
<div class="container">
	...
	<a class="btn" href="add_custumers.php">toevoegen</a>
	

	
<!-- 	<form  class="col-md-4" method="GET" action="indexsearch.php" id="searchform" name="search"> 
	    <input id="search-bar" type="text" class="form-control inputsearch" placeholder="Search..." name="search"> 
	    <input type="submit" class="search-btn"> 
	</form> 
	<a class="btn btn-info col-md-2" href="logout.php">logout</a> -->
	<br>
